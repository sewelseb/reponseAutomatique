  ...
  try
    {
      ...
      //$bdd= new PDO('mysql:host=localhost;dbname=iteachyou', 'client', 'MKjzfPDw6StRPLPN');
      //array (PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION);
      //$bdd = new mysqli("localhost", "root", "", "iteachyou");
      $bdd = new PDO('mysql:host=localhost;dbname=reponseAutomatique', 'root', '');
